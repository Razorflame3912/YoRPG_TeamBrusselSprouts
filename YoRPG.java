...
public class YoRPG
{
	...
	s = "Choose thine class, noble warrior.\n";
	s+= "\t1: Warrior\n";
	s+= "\t2: Mage\n";
	s+= "\t3: Rogue\n";
	s+= "\t4: Brute\n";
	...
	//Make Pat be the class that the player chose

		//instantiate the player's and monster's character (I WANT THIS TO BE INIT PAT)
	if (classChoice == 1){
